...
const products = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1513883049090-dd0ac743c82f?w=600&q=80",
  },
];
...
const testimonials = [
  {
    quote:
      "Glamova completely transformed my skincare routine. The Rose Glow Serum is absolutely magical — my skin has never looked better.",
    name: "Sophia L.",
    role: "Verified Buyer",
  ...
  {
    quote:
      "The lipsticks stay on all day and the colors are so rich and pigmented. I get compliments everywhere I go!",
    name: "Priya R.",
    role: "Beauty Blogger",
  ...
  {
    quote:
      "Finally a brand that takes clean beauty seriously without compromising on luxury. Glamova is my forever brand.",
    name: "Isabelle M.",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-24 grid md:grid-cols-2 gap-16 items-center w-full">
          <div>
            ...
            <p className="hero-sub text-white/65 text-lg leading-relaxed mb-10 max-w-lg">
              Glamova brings you clean, luxurious cosmetics crafted from
              nature's finest ingredients — for every skin type, every mood,
              every moment.
            </p>
      ...
      <section className="py-24 bg-cream overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-charcoal text-white p-6 rounded-sm shadow-xl w-44">
                <div className="font-display text-3xl font-bold text-rose">
                  2012
                </div>
          ...
          <ScrollReveal direction="right">
            <p className="text-rose text-xs font-semibold tracking-[0.18em] uppercase mb-4">
              Our Story
            </p>
            ...
            <p className="text-slate leading-relaxed mb-4">
              Glamova was born from a passion for beauty that doesn't
              compromise. We believe that what you put on your skin should be as
              pure as what you put in your body — effective, ethical, and
              exquisitely luxurious.
            </p>
            <p className="text-slate leading-relaxed mb-8">
              Our 200+ products are formulated by expert cosmetic chemists and
              tested by beauty professionals to ensure they perform beautifully
              — every time.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-5xl font-semibold text-charcoal">
                Our Collections
              </h2>
            </div>
          </ScrollReveal>
                ...
                <div className="card-lift group overflow-hidden rounded-sm bg-white border border-gray-100 shadow-sm">
                  <div className="overflow-hidden h-52 relative img-overlay">
                    ...
                    <div className="absolute bottom-4 left-4 z-10">
                      <span className="bg-rose text-white text-xs font-semibold px-3 py-1 rounded-sm">
                        {title}
                      </span>
                    </div>
                  </div>
                  <div className="p-6">
                    ...
                    <Link
                      to="/services"
                      className="text-rose text-sm font-semibold flex items-center gap-2 group-hover:gap-3 transition-all"
                    >
                      Shop now
                      <svg
                        className="w-4 h-4"
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left">
            ...
            {[
              [
                ...
                "No parabens, sulfates, or synthetic fragrances. Ever.",
              ],
              [
                "Dermatologist Tested",
                "Every formula is clinically tested for safety and efficacy.",
              ],
              [
                "Cruelty Free & Vegan",
                "We never test on animals and use no animal-derived ingredients.",
              ],
              [
                "Sustainable Packaging",
                "Eco-conscious packaging that loves the planet as much as we do.",
              ],
            ].map(([title, desc]) => (
          ...
          <ScrollReveal direction="right">
            <div className="relative group">
              <div className="absolute -inset-2 bg-gradient-to-r from-rose/30 to-gold/30 rounded-lg blur-xl opacity-0 group-hover:opacity-100 transition duration-500"></div>
              <img
                src={IMAGES.feature}
                alt="Glamova luxury cosmetic shop"
                className="relative w-full h-[520px] object-cover rounded-sm shadow-2xl shadow-black/50 transform transition duration-500 group-hover:scale-[1.02]"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 rounded-b-sm">
                <p className="text-white text-sm font-semibold">
                  ✨ Glamova Beauty Store
                </p>
                <p className="text-white/60 text-xs">
                  Experience luxury cosmetics in person
                </p>
              </div>
            </div>
          </ScrollReveal>
            ...
            {testimonials.map(({ quote, name, role, img }, i) => (
              <ScrollReveal key={name} direction="up" delay={i * 0.1}>
                <div className="bg-white p-8 rounded-sm shadow-sm border-t-4 border-rose h-full flex flex-col">
                  ...
                  <p className="text-slate text-sm leading-relaxed flex-1 mb-6 italic">
                    {quote}
                  </p>
        ...
        <ScrollReveal>
          <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="text-white/60 text-lg mb-10">
              Explore our full range of luxury beauty products and find what
              makes you glow.
            </p>
            <Link
              to="/services"
